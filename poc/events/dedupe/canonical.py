...
def make_canonical(candidates, decisions, tiers):
    representative=max(candidates,key=lambda item:source_quality(item,tiers)); taxonomy=classify_many(candidates)
